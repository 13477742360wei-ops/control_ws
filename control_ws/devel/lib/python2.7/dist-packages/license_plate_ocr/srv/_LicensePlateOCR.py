...
"""autogenerated by genpy from license_plate_ocr/LicensePlateOCRRequest.msg. Do not edit."""
import codecs
import sys
...
class LicensePlateOCRRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "license_plate_ocr/LicensePlateOCRRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LicensePlateOCRRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from license_plate_ocr/LicensePlateOCRResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class LicensePlateOCRResponse(genpy.Message):
  _md5sum = "992dcf1bf25275ccf4fb7dcadfb15de4"
  _type = "license_plate_ocr/LicensePlateOCRResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# 响应：返回识别结果
string[] plate_texts
float32[] confidences
string status_message
"""
  __slots__ = ['plate_texts','confidences','status_message']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       plate_texts,confidences,status_message
    ...
    """
    if args or kwds:
      super(LicensePlateOCRResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.plate_texts is None:
        self.plate_texts = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.plate_texts)
      buff.write(_struct_I.pack(length))
      for val1 in self.plate_texts:
        length = len(val1)
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class LicensePlateOCR(object):
  _type          = 'license_plate_ocr/LicensePlateOCR'
  _md5sum = 'bc0aa725c8a3f5abac8f917be5e39777'
  _request_class  = LicensePlateOCRRequest
  _response_class = LicensePlateOCRResponse
